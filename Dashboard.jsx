    ...
    <>
        ...
        <div className="developer-grid">
          <div className="dev-card">
            ...
            <p className="dev-desc">
              Passionate about backend architecture, clean frontend design, and scalable software
          ...
          <div className="dev-card">
            ...
            <p className="dev-desc">
              Focused on AI-driven applications and full-stack development.
      ...
      <style>{`
        ...
        .dev-card:hover {
          ...
          box-shadow: 0 15px 35px rgba(78, 204, 163, 0.25);
        }
